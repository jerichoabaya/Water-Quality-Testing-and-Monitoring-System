...
<head>
  ...
  <style>
    ...
    .safe-text { fill: #00c6ff; }
    .neutral-text { fill: #28a745; }
    .warning-text { fill: #ffc107; }
    .fail-text { fill: #dc3545; }
...
<div class="gauge">
  ...
  <svg class="status-svg" viewBox="0 0 350 350">
    ...
    <text class="arc-text safe-text"><textPath href="#arc-safe">SAFE</textPath></text>
    <text class="arc-text neutral-text"><textPath href="#arc-neutral">NEUTRAL</textPath></text>
    <text class="arc-text warning-text"><textPath href="#arc-warning">WARNING</textPath></text>
    <text class="arc-text fail-text"><textPath href="#arc-fail">FAILED</textPath></text>
  </svg>
</div>
